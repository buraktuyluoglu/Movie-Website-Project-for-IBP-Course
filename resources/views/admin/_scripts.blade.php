...
<script src="{{asset("assets_admin")}}/plugins/bootstrap4-duallistbox/jquery.bootstrap-duallistbox.min.js"></script>
<!-- InputMask -->
<script src="{{asset("assets_admin")}}/plugins/moment/moment.min.js"></script>
<script src="{{asset("assets_admin")}}/plugins/inputmask/jquery.inputmask.min.js"></script>
<!-- date-range-picker -->
...
<!-- Bootstrap Switch -->
<script src="{{asset("assets_admin")}}/plugins/bootstrap-switch/js/bootstrap-switch.min.js"></script>
<!-- BS-Stepper -->
<script src="{{asset("assets_admin")}}/plugins/bs-stepper/js/bs-stepper.min.js"></script>
<!-- dropzonejs -->
